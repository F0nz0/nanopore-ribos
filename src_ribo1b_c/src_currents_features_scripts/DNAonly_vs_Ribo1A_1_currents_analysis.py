...
dna_only_folder = "/lustre/bio_running/DNA_Ribo_2023/DNA_only"
ribo_folder = "/lustre/bio_running/DNA_Ribo_2023/RIBO1A_1"
dna_only_eventalign_filename = "DNA_only.eventalign"
ribo_eventalign_filename = "RIBO1A_1.eventalign"
...
results_folder_path = "/lustre/bio_running/DNA_Ribo_2023/results/currents_features_with_raw_data"
...
def eventalign_split_for_rev(eventalign_path):
    ...
    print("Total rows evaluated from the eventalign file:", c, flush=True)
    print("Total rows assigned as forward:", c - rev_compl_notPal_count, flush=True)
    print("Total reverse complement found:", rev_compl_count, flush=True)
    print("Total reverse complement found (palindromic excluded):", rev_compl_notPal_count, flush=True)
...
df_forward_merged.to_csv(os.path.join(results_folder_path, f"dna_vs_ribo1a_1.forward.tsv"), sep="\t")
df_reverse_merged.to_csv(os.path.join(results_folder_path, f"dna_vs_ribo1a_1.reverse.tsv"), sep="\t")
